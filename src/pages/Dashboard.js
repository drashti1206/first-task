    ...
    <div className="dashboard p-4 sm:p-6 bg-gray-100 min-h-screen">
      ...
      <div className="stats-cards grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="card bg-white shadow-md rounded-lg p-4 sm:p-6 flex flex-col items-center hover:shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-700 mb-2">Number of Employees</h2>
          <p className="text-2xl sm:text-3xl font-bold text-indigo-500">50</p>
          <img src="https://img.icons8.com/ios/452/teamwork.png" alt="Team" className="w-12 h-12 mt-4" />
        </div>
        <div className="card bg-white shadow-md rounded-lg p-4 sm:p-6 flex flex-col items-center hover:shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-700 mb-2">Active Departments</h2>
          <p className="text-2xl sm:text-3xl font-bold text-indigo-500">10</p>
          <img src="https://img.icons8.com/ios/452/building.png" alt="Departments" className="w-12 h-12 mt-4" />
        </div>
        <div className="card bg-white shadow-md rounded-lg p-4 sm:p-6 flex flex-col items-center hover:shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-700 mb-2">Projects</h2>
      ...
      <div className="recent-activities mt-8 sm:mt-12 bg-white rounded-lg shadow-md p-4 sm:p-6">
        ...
        <ul className="space-y-4">
          <li className="flex items-center space-x-3">
            ...
            <p className="text-gray-700">Divya Patel updated the employee directory</p>
          </li>
          <li className="flex items-center space-x-3">
            <span className="text-gray-600">💼</span>
          ...
          <li className="flex items-center space-x-3">
            <span className="text-gray-600">📈</span>
            <p className="text-gray-700">Department 5 exceeded their monthly targets</p>
          </li>
        </ul>
      </div>
      ...
      <div className="quick-actions mt-8 sm:mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="action-card bg-white shadow-md rounded-lg p-6 text-center hover:shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
          ...
          <button className="bg-indigo-500 text-white py-2 px-4 rounded-md">Add</button>
        </div>
        <div className="action-card bg-white shadow-md rounded-lg p-6 text-center hover:shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
          <h3 className="text-lg font-semibold text-gray-800 mb-2">View Reports</h3>
          <button className="bg-green-500 text-white py-2 px-4 rounded-md">View</button>
        </div>
        <div className="action-card bg-white shadow-md rounded-lg p-6 text-center hover:shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Manage Projects</h3>
          <button className="bg-yellow-500 text-white py-2 px-4 rounded-md">Manage</button>
        </div>
      </div>
