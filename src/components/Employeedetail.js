...
const EmployeeDetail = () => {
    ...
    if (loading) return <div className="text-center text-gray-700">Loading employee details...</div>;
    ...
    return (
        <div className="flex flex-col items-center justify-start w-full min-h-screen p-1 sm:p-6 bg-gray-100">
            <div className="mb-6 mt-10 w-full max-w-4xl text-center">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4">Employee Details</h1>
            </div>
            ...
            {employee && (
                <div className="w-full max-w-md sm:max-w-lg lg:max-w-4xl bg-white shadow-md rounded-lg p-6">
                    ...
                    <p className="text-lg sm:text-xl font-semibold mb-4">
                        Department: <span className="font-normal">{employee.department}</span>
                    </p>
                    <p className="text-lg sm:text-xl font-semibold mb-4">
